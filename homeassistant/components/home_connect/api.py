...
class HomeConnectDevice:
    ...
    def __init__(
        self, hass: core.HomeAssistant, appliance: HomeConnectAppliance
    ) -> None:
...
class DeviceWithPrograms(HomeConnectDevice):
    ...
    def get_program_switches(self):
        ...
        _LOGGER.debug("Programs Switches: %s", programs)
...
class FridgeFreezer(HomeConnectDevice):
    """Fridge/Freezer class."""

    def get_entity_info(self) -> dict:
        """Return empty dict for backwards compatibility."""
        return {}


class Refrigerator(HomeConnectDevice):
    """Refrigerator class."""
...
class Freezer(HomeConnectDevice):
    """Freezer class."""
...
class CookProcessor(HomeConnectDevice):
    """CookProcessor class."""
