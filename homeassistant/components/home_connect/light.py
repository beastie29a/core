        ...
        for device_dict in hc_api.devices:
            ...
            entity_list += [
                HomeConnectCoolingLight(
                    device_dict[ATTR_DEVICE], entity_description=description
                )
                for description in LIGHTS
                if description.exists_fn(device_dict[ATTR_DEVICE])
            ]
...
class HomeConnectCoolingLight(HomeConnectLight):
    ...
    def __init__(
        ...
        super().__init__(device, entity_description.key, None)
