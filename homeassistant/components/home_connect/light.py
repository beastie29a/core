...
async def async_setup_entry(
    ...
    def get_entities():
        ...
        for device_dict in hc_api.devices:
            ...
            entity_list = [
                HomeConnectLight(**d, coordinator=coordinator) for d in entity_dicts
            ]
            ...
            entity_list.extend(
                HomeConnectCoolingLight(
                    ...
                    coordinator=coordinator.init_entity(
                        device=device,
                        entity_unique_id=f"{device.appliance.haId}-{description.key}",
                        endpoint=f"/settings/{description.on_key}",
                    ),
                )
...
class HomeConnectLight(HomeConnectEntity, LightEntity):
    ...
    def __init__(
        self, device, desc, ambient, coordinator: HomeConnectDataUpdateCoordinator
    ):
...
class HomeConnectCoolingLight(HomeConnectLight):
    ...
    def __init__(
        ...
        super().__init__(
            device, entity_description.key, ambient, coordinator=coordinator
        )
